...
import './xd_supprimer.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDVhicules extends StatelessWidget {
  XDVhicules({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child:
              ...
              children: <Widget>[
                ...
                Padding(
                  padding: EdgeInsets.fromLTRB(19.0, 29.9, 19.0, 32.9),
                  child:
                      ...
                      Pinned.fromPins(
                        ...
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromPins(
                              Pin(startFraction: 0.3648, endFraction: 0.3648),
          ...
          Pinned.fromPins(
              Pin(start: 15.0, end: 14.0), Pin(size: 102.0, middle: 0.8),
              child: Stack(children: [
                Pinned.fromPins(
                  Pin(start: 15.0, end: 14.0),
                  Pin(size: 102.0, middle: 0.7072),
                  child:
                      // Adobe XD layer: 'Véhicule' (component)
                      XDListeResultat(),
                ),
                Pinned.fromPins(
                  Pin(size: 52.0, end: 30.0),
                  Pin(size: 50.0, middle: 0.69),
                  child:
                      // Adobe XD layer: 'Supprimer' (component)
                      XDSupprimer(),
                ),
              ]))
        ],
